...
enum FocusStatusAlertCase {
    ...
    var title: String {
        switch self {
            ...
            case .finishingPomodoroCase(let pomodoroString, _):
    ...
    private func getFinishTimerAlertBody() -> String {
        guard case .finishingTimerCase(let subject) = self else { return String() }
    ...
    private func getFinishPomodoroAlertBody() -> String {
        guard case .finishingPomodoroCase(let pomodoroString, _) = self else {
            return String()
        }
