...
extension SplashViewController: ViewCodeProtocol {
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            plaImageView.widthAnchor.constraint(equalTo: view.widthAnchor, multiplier: 0.288),
            plaImageView.heightAnchor.constraint(equalTo: plaImageView.widthAnchor, multiplier: 155 / 196),
            plaImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -(view.frame.width * 0.16)),
            ...
            nnoImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: view.frame.width * 0.16),
