...
extension FocusPickerViewController: FocusPickerDelegate {
    func startButtonTapped() {
        ...
        liveActivity.startActivity(endTime: Date().addingTimeInterval(TimeInterval(viewModel.focusSessionModel.totalSeconds)), title: viewModel.focusSessionModel.subject?.unwrappedName ?? "Free Focus")
    }
